            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.LeadsResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/leads/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Lead update details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "models.Lead": {
            ...
            "properties": {
                ...
                "state": {
                    "description": "Core fields (synced with external API)",
                    "type": "integer",
                    "example": 0
                },
                "surface_id": {
