    ...
    "definitions": {
        ...
        "client.FinancingProvider": {
            ...
            "properties": {
                ...
                "option": {
                    "$ref": "#/definitions/client.FinancingOption"
                }
            }
        },
        "client.HouseInfo": {
            ...
            "properties": {
                ...
                "inverter": {
                    "$ref": "#/definitions/client.InverterInfo"
                },
                "inverter_count": {
                    "type": "integer"
                },
                ...
                "panel": {
                    "$ref": "#/definitions/client.PanelInfo"
                },
                "panel_count": {
                    "type": "integer"
                },
        ...
        "client.LeadCompletionResponse": {
            "type": "object",
            "properties": {
                "lead": {
                    "$ref": "#/definitions/client.LeadData"
                }
            }
        },
        "client.LeadData": {
            ...
            "properties": {
                ...
                "address": {
                    "$ref": "#/definitions/client.AddressInfo"
                },
                "build": {
                    "$ref": "#/definitions/client.BuildInfo"
                },
                "company": {
                    "$ref": "#/definitions/client.CompanyInfo"
                },
                "company_id": {
                    "type": "integer"
                },
                ...
                "current_provider": {
                    "$ref": "#/definitions/client.ProviderInfo"
                },
                "electricity_cost_post": {
                    "type": "number"
                },
                "electricity_cost_pre": {
                    "type": "number"
                },
                "enium_loan_identifier": {
                    "type": "string"
                },
                "financing_provider": {
                    "$ref": "#/definitions/client.FinancingProvider"
                },
                "future_provider": {
                    "$ref": "#/definitions/client.ProviderInfo"
                },
                "house": {
                    "$ref": "#/definitions/client.HouseInfo"
                },
                "house_id": {
                    "type": "integer"
                },
                ...
                "production": {
                    "$ref": "#/definitions/client.ProductionInfo"
                },
                "roof_material": {
                    "type": "integer"
                },
        ...
        "client.ProviderInfo": {
            ...
            "properties": {
                ...
                "tariff": {
                    "$ref": "#/definitions/client.TariffInfo"
                },
                "tariff_id": {
                    "type": "integer"
                },
                "utility": {
                    "$ref": "#/definitions/client.UtilityInfo"
                },
                "utility_id": {
                    "type": "integer"
                }
        ...
        "client.Status3DProjectResponse": {
            ...
            "properties": {
                ...
                "inverter": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/client.Inverter"
                    }
                },
                "lead_completion": {
                    "$ref": "#/definitions/client.LeadCompletionResponse"
                },
                "panel": {
                    "$ref": "#/definitions/client.Panel"
                },
                "price_breakdown": {
